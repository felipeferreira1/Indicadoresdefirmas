...
write.xlsx(ind.lucros_patr, "Medidas de Posição (2ª parte).xlsx", sheetName = "Lucros Retidos - Patr. Tot.", row.names = FALSE, showNA = FALSE, append = FALSE)
write.xlsx(v2.ind.lucros_patr, "Medidas de Posição (2ª parte).xlsx", sheetName = "Lucros Retidos - Patr. Líq.", row.names = FALSE, showNA = FALSE, append = TRUE)
write.xlsx(ind.DE, "Medidas de Posição (2ª parte).xlsx", sheetName = "Debt - Equity Ratio", row.names = FALSE, showNA = FALSE, append = TRUE)
write.xlsx(ind.PE_basico, "Medidas de Posição (2ª parte).xlsx", sheetName = "Price - Earnings Ratio (v1)", row.names = FALSE, showNA = FALSE, append = TRUE)
write.xlsx(ind.PE_diluido, "Medidas de Posição (2ª parte).xlsx", sheetName = "Price - Earnings Ratio (v2)", row.names = FALSE, showNA = FALSE, append = TRUE)